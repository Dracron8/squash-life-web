**Next Instructions for C2 / Internal Implementer – Start v4 with Mobile App, Payments, and AI Scheduling (027)**
...
1. **Choose and Implement Core v4 Feature**
   - Option A: Mobile App - Enhance PWA or add mobile-specific views for TD and players (e.g., responsive wizard, mobile schedule viewer).
